  ...
  data(){
    return{
      ...
      items:[
        ...
        {type:'select',label:'求职状态',prop:'jobStatus',name:'jobStatus',placeholder:'求职状态',options:[{value:'待业可以立即上岗',label:'待业可以立即上岗'},{value:'在岗考虑新工作',label:'在岗考虑新工作'}]},
        ...
        {type:'select',label:'状态',prop:'status',name:'status',placeholder:'状态',options:[{value:1,label:'开放'},{value:0,label:'关闭'}]},
